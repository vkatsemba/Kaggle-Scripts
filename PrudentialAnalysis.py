...
test = pd.read_csv('C:\Users\Vadim Katsemba\Documents\prudentialtest.csv')
train = pd.read_csv('C:\Users\Vadim Katsemba\Documents\prudentialtrain.csv')
...
test.to_csv('C:/Users/Vadim Katsemba/Documents/model_output.csv',columns=['Id','Response'])
